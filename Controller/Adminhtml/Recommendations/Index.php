...
class Index extends Action implements HttpGetActionInterface
{
    ...
    public function execute(): ResultInterface
    {
        ...
        $resultPage->getConfig()->getTitle()->prepend(__('Store Intelligence — Recommendations'));
        return $resultPage;
    }

    // ponytail: skip secret key so email deep-links work; GET-only page, no state change
    /**
     * _process url keys.
     *
     * @return bool
